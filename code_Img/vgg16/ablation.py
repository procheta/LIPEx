...
# Plot the re-prediction change rate of predictor removal of features selected by LIME and LIPEx
import matplotlib.pyplot as plt
import seaborn as sb
Feature_number = ['Top-1', 'Top-2', 'Top-3', 'Top-4', 'Top-5']
plt.figure(figsize=(16,16))
fig, ax = plt.subplots()
ax.plot(Feature_number,average_LIME.tolist(), label='Removal of Features Detected by LIME')
ax.plot(Feature_number,average_LIPEx.tolist(), label='Removal of Features Detected by LIPEx')
sb.scatterplot(x=Feature_number, y=average_LIME.tolist(), s=20)
sb.scatterplot(x=Feature_number, y=average_LIPEx.tolist(), s=20)

plt.xlabel('Number of Features Removed')
plt.ylabel('Re-Prediction Change Rate')
# plt.title("data ablation​​")
plt.legend()
PATH = 'LIPEx/plot/ablation/vgg16.png'
plt.savefig(PATH)
plt.close()